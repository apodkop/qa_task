...
| 7 | Поле Email | При невалидном вводе email сообщение появляется только после клика зарегистрироваться | [ссылка] | Исправить логику появления сообщения об ошибке | 3 |
